<ul class="breadcrumbs">
    ...
    <li>Penguji Skripsi <span class="separator"></li></span>
    <li>Edit Data Dosen - Penguji Skripsi</li>
</ul>
        
<div class="pageheader">
    <div class="pageicon"><span class="iconfa-tags"></span></div>
    <div class="pagetitle">
        <h1>Edit Data Dosen - Penguji Skripsi</h1>
    </div>
</div><!--pageheader-->
...
<body>
    <form action="index.php?posisi=Back&file=proses_edit_dosen_penguji_skripsi" method="POST">
    <fieldset> 

<div class="widget">
            <h4 class="widgettitle">Form Edit Data Dosen - Penguji Skripsi</h4>
...
<p>
    <label for="dosbing">DOSEN PENGUJI</label>
    <span class="field">
    <input type="text" class="input-xlarge" id="nim" placeholder="Masukkan Nama Dosen" name="input_dosen_penguji" value="<?php echo $_GET['dosen_penguji'] ?>" disable/></span>
</p>                         
